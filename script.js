...
function win() {
  ...
  if (s % 60 < 10) {
      stats.textContent = "You won: " + stars + " stars in " + movesCounter + " moves with time: " + m + ":0" + s % 60;
  } else {
      stats.textContent = "You won: " + stars + " stars in " + movesCounter + " moves with time: " + m + ":" + s % 60;
  }
}
